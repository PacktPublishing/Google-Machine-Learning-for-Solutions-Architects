...
SERVICE_ACCOUNT_EMAIL = "data-processing-sa@YOUR PROJECT ID.iam.gserviceaccount.com" # REPLACE YOUR PROJECT ID IN THE STRING
PYSPARK_URI = "gs://kk-ml-book-us-central/code/chapter-6-pyspark.py" # REPLACE WITH YOUR BUCKET NAME AND FILE PATH
